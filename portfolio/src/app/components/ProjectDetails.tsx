  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center w-full h-full overflow-hidden backdrop-blur-sm">
      ...
      >
        ...
        >
          <Image src="/close.svg" className="w-6 h-6" alt="close" width={6} height={6}/>
        </button>
        <Image src={image} alt={title} className="w-full rounded-t-2xl " quality={100} width={100} height={100}/>
        <div className="p-5">
